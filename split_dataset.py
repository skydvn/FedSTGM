...
if __name__=='__main__':
    ...
    # parser.add_argument("--data_split_file", type=str, default="dataset/data_split/CIFAR100_split.pkl")
    ...
    parser.add_argument("--datadir", type=str, default="dataset")
    parser.add_argument("--data_split_file", type=str, default="dataset/data_split/MNIST-SVHN-FASHION_split.pkl")
    parser.add_argument("--client_num", type=int, default=10)
    parser.add_argument("--task_num", type=int, default=10)
    parser.add_argument("--class_each_task", type=int, default=2)
    parser.add_argument("--class_split", type=int, default=1.5)
    parser.add_argument("--seed", type=int, default=2201)
